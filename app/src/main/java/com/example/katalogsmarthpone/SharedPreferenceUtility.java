...
import com.example.katalogsmarthpone.model.Handphone;
...
public class SharedPreferenceUtility {
     ...
     */
    public static List<Handphone> getAllTransaksi(Context ctx) {
    ...
    /*
        ...
        Perhatikan bahwa data disimpan dalam format JSON String
     */
    private static void saveAllTransaksi(Context ctx, List<Handphone> trs) {
     ...
     */
    public static void addTransaksi(Context ctx, Handphone tr) {
        List<Handphone> trs = getAllTransaksi(ctx);
        trs.add(tr);
        saveAllTransaksi(ctx,trs);
    }

    public static void editTransaksi(Context ctx, Handphone tr) {
        List<Handphone> trs = getAllTransaksi(ctx);
        for (Handphone tre:trs) {
