...
public class FormHandphoneActivity extends AppCompatActivity {
    ...
    final String[] tipeTransaksi = {Handphone.XIAOMI, Handphone.REALME, Handphone.IPHONE , Handphone.SAMSUNG , Handphone.HUAWEI};
