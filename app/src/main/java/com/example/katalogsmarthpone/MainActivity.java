...
public class MainActivity extends AppCompatActivity {
    ...
    DaftarHandphoneAdapter adapter;
    List<Handphone> daftarTransaksi;
    ...
    private void setupListview() {
        adapter = new DaftarHandphoneAdapter(this, daftarTransaksi);
    ...
    private void bukaFormTambahTransaksi() {
        Intent intent = new Intent(this, FormHandphoneActivity.class);
