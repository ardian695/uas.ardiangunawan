...
public class DaftarHandphoneAdapter extends ArrayAdapter<Handphone> {
    Context context;

    public DaftarHandphoneAdapter(@NonNull Context context, @NonNull List<Handphone> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.txModel = convertView.findViewById(R.id.row_tx_model_transaksi);
        ...
        if (tr.getJenis().equals(Handphone.XIAOMI)) {
